...
//				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "ex1-hermit-3", true));
				...
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "ex4-demographics-1", true));
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "ex4-demographics-2-price-interventions", true));
				...
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "financial-economy-leverage-1", true));
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "financial-economy-fast-4", true));
			} catch (IOException e) {
