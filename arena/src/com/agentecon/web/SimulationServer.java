...
public class SimulationServer extends VisServer {
	...
	public SimulationServer(int port) throws IOException, InterruptedException {
		...
		if (SimulationConfig.isServerConfig()) {
			try {
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "ex1-hermit-4", true));
				this.simulations.add(new GitSimulationHandle("meisser", "course2019", "ex1-monetary-1", true));
